                                ...
                                <div class="col">
                                    ...
                                    <div class="form group mb-3">
                                        <div class="input-group">
                                            {!! Form::select('category_id', $categories, null, ['class' => 'form-control custom-select', 'id' => 'category_id']) !!}
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('product_unit_id', $units, null, ['class' => 'form-control custom-select', 'id' => 'product_unit_id']) !!}
                                        <div class="input-group-append">
