                ...
                @can('akses penjualan')
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ route('sales.index') }}" class="small-box-footer">Lebih lanjut <i
                ...
                @can('akses pembayaran')
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('payments.index') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                @endcan
                ...
                @can('akses user')
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{ route('users.index') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                @endcan
                ...
                @can('akses barang')
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('products.index') }}" class="small-box-footer">Lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                @endcan
