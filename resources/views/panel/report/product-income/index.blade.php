...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Laporan Arus Barang</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid append-here">
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline card-info" style="position: relative;">
                        @include('include.preloader')
                        <div class="card-header">
                            <h3 class="card-title">Cari Laporan Arus Barang</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
@push('js')
    ...
    <script src="{{ asset('') }}/dist/js/report/product-income/index.js"></script>
@endpush
