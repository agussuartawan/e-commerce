...
<div class="form-group">
    ...
    {!! Form::select('account_type_id', $account_types, null, ['class' => 'form-control custom-select', 'id' => 'account_type_id', 'disabled' => $disable, 'required' => true]) !!}
</div>

@if ($account->exists)
    <div class="form-group">
        <label for="account_number">No Ref</label>
        {!! Form::text('account_number', null, ['class' => 'form-control', 'id' => 'account_number', 'disabled' => $disable, 'required' => true]) !!}
    </div>
@else
    <label for="account_number">No Ref</label>
