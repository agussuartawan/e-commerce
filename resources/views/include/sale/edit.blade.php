...
<div class="row">
    ...
    <div class="col">
        <div class="form-group">
            ...
            {!! Form::datetimeLocal('date', \Carbon\Carbon::parse($sale->date), ['class' => 'form-control', 'id' => 'date']) !!}
        </div>
    </div>
</div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group" id="input-qty">
                ...
                <input type="text" class="form-control input-number" name="qty" id="qty" value="{{ $sale->qty }}"
                    min="1" max="999999">
                <div class="input-group-btn">
...
<div class="row mt-3">
    ...
    <div class="col-md-4">
        <div class="form-group">
            @php
                if ($sale->payment_status_id == \App\Models\PaymentStatus::LUNAS || $sale->payment_status_id == \App\Models\PaymentStatus::MENUNGGU_KONFIRMASI) {
                    $disable = true;
                } else {
                    $disable = false;
                }
