        ...
        <table class="table" style="margin-top: 5px">
            ...
            <tbody>
                @forelse ($trialBalances->account as $account)
                    <tr>
                        ...
                        <td>{{ $account->name }}</td>
                        <td style="text-align: right">Rp. {{ rupiah($account->pivot->debit) }}</td>
                        <td style="text-align: right">Rp. {{ rupiah($account->pivot->credit) }}</td>
                    </tr>
                @empty
                    <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align: right">Rp. {{ rupiah($trialBalances->account->sum('debit')) }}</th>
                    <th style="text-align: right">Rp. {{ rupiah($trialBalances->account->sum('credit')) }}</th>
                </tr>
            </tfoot>
        </table>
