        ...
        <table class="table" style="margin-top: 5px">
            ...
            <tbody>
                @forelse ($journals as $key => $journal)
                    <tr>
                        ...
                        <td style="text-align: left">{{ $journal->account->account_number }}</td>
                        <td style="text-align: left">Rp. {{ rupiah($journal->debit) }}</td>
                        <td style="text-align: left">Rp. {{ rupiah($journal->credit) }}</td>
                    </tr>
                @empty
                    <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align: left">Rp. {{ rupiah($journals->sum('debit')) }}</th>
                    <th style="text-align: left">Rp. {{ rupiah($journals->sum('credit')) }}</th>
                </tr>
            </tfoot>
        </table>
