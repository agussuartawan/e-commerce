                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <h6><strong>{{ \Carbon\Carbon::parse($sale->payment->date)->isoFormat('DD MM YYYY') }}</strong></h6>
                            </div>
                        </div>
                        <hr>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <h6>Transfer ke {{ $sale->bank->name }} {{ $sale->bank->account_number }}</h6>
                            </div>
                        </div>
                        <hr>
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <h6>{{ $sale->product->product_name }} {{ $sale->product->size }}{{ $sale->product->product_unit->name }} &emsp;&emsp; Rp. {{ rupiah($sale->product->selling_price) }} x {{ $sale->qty }}</h6>
                                <small>(Variasi : {{ $sale->product_color->name }}, {{ $sale->product_fragrance->name }})</small>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
